...
import ReusableFunctions.AccountPageAdminSide;
...
public class TC006 extends SuiteOneBase{
	...
	public void SuiteOneCaseTwoTest(String AdminUsername,String AdminPassword,String LaunchPassword, String State,String Profession,
		...
		try
		{
			...
			test=extent.startTest("Purchase Policy from New Quote : CSR/Admin");
			//Login Method	
			...
			click(AdminPage.AdminBuyDashboardGetAQuoteButton(), "Get A Quote Button");
			
			
					
			//*******************Professional Detail Screen*******************/
			String EffectiveDate1 = MyDate.todaysDate();
			MyProfessionalDetails.ProfessionalDetail_NewUser(State, Profession, Speciality1, county, writeYourSpecialty,
					Employment1, hasEmployerCoverage, Coverage, RetroActiveDate, AnticipatedGraduationMonth,
					AnticipatedGraduationYear, Graduatedinlast5years, GraduatedinLast_Month, GraduatedinLast_Year, WorkPerWeek,
					disciplinaryboardaction5Years, NoOfClaims, BoardAction, EffectiveDate1, Username, IntendedOwner);
				...
				//*********************Account Page*****************
		AccountPageAdminSide.AddAccount(Username, Username, FirstName, LastName, PrimaryPhoneNumberDropDown, PrimaryPhoneNo,
				AlternatePhoneNumberDropDown, AlternatePhoneNumber);
		
		//*********Policy Details***********/
		PolicyDetails.ProfessionalDetail_NewUser(Employment1, CHFirstName, CHLastName, ProfessionalDesignation, BusinessEntity, pStreetAddress,
		 		...
		 		/* if(!(PolicyNumber==null))
					{
		 		    ...
		 		    click(PolicyDetailPage.TCcheck(), "TC Check Box");
