...
import ReusableFunctions.EmailVerifcationAsAdmin;
...
import ReusableFunctions.T0AndPaymentNotification;
import ReusableFunctions.T120AndT95Notification;
import ReusableFunctions.T30Notification;
import ReusableFunctions.T7Notification;
import TestSuiteBase.SuiteUtility;
import Utility.Read_XLSX;



public class TC010 extends SuiteOneBase {
	...
	public void SuiteOneCaseTwoTest(String AdminUsername,String AdminPassword,String LaunchPassword, String State,String Profession,
			...
			String PolicyNumber,
			String Username,String Password,String EmailTemplateNameCaptured,String SubjectLine, String PolicyNumberRenewal) throws Exception{
		...
		try
		{
			...
			test=extent.startTest("Send T-0 Renewal Notifications");
			...
			act.doubleClick(AdminPage.AdminDashboardSelectUser());*/
	...
	/*************Admin Side***********************/
				...
				for(int i =1; i<=20; i++)
				{
					...
					if (SystemOptions.equals("Renewal and Payment Testing"))
					{
						System.out.println("In");
					  click(driver.findElement(By.xpath("(//*[contains(text(),'System Admin')])[2]//following::li"+"["+i+"]/a")),"Renewal and Payment Testing");
						Thread.sleep(2000);
						break;
					}
...
//Send T-120 and T-95 Notification
                
                T120AndT95Notification.SendT120AndT30Notification(PolicyNumber);
     ...
     //Again login to get Renewal policy no. and Click on Looks good Button
			...
			try{
                ...
                click(RenewalTesting.LooksGood(),"Looks Good");
               Thread.sleep(3000);
                click(HomePage.SignoutButton(),"Sign Out");
                
                
                
    //Login as Admin to send T-30 Notification and T-7
                ...
                T30Notification.SendT30Notification(PolicyNumber);
				
				Thread.sleep(3000);
	//T-7 notification
				T7Notification.SendT7Notification(PolicyNumber);
		     
				
	//T-0 notification and do Payment.
				
				T0AndPaymentNotification.SendT0AndPaymentNotification(PolicyNumber,PolicyNumberRenewal);
				
	 		    
 //Login as Admin and Verify the mail sent to user.
	 		    
				
				 EmailVerifcationAsAdmin.VerifyEmail(AdminUsername, AdminPassword, LaunchPassword, SubjectLine, PolicyNumberRenewal);
	 		  ...
	 		  click(HomePage.SignoutButton(),"Sign Out");
	 		  Add_Log.info("Sign out as an admin");
