...
public class TC049 extends SuiteOneBase {
	...
	public void SuiteOneCaseTwoTest(String Username,String Password,String State,String Profession,
			...
			String PolicyNumber,String UsernameAdmin, String PasswordAdmin,String EmailTemplateName, String SubjectLine,String PolicyNumberRenewal,String UWReason,String UWReasonText, String ScreenshotLink) throws Exception{
		...
		try
		{
			...
			MyProfessionalDetails.ProfessionalDetail( State, Profession,
               ...
               try{
				...
				RenewalTesting.PolicyNoRenewalUW().sendKeys(PolicyNumber);
				Add_Log.info("Enter policy No");
				
				RenewalTesting.PolicyNoRenewalUW().sendKeys(Keys.ENTER);
				Add_Log.info("Press Enter ");
				
				 Actions act = new Actions(driver);
				 act.moveToElement(driver.findElement(By.xpath(".//*[@class='table table-striped table-bordered mx-datagrid-body-table']/tbody/tr[1]/td[1]/div/span/a"))).doubleClick().build().perform();
				
				Select Sel = new Select(RenewalTesting.UWRefferralDecisionBox());
				Sel.selectByVisibleText(UWReason);		
				Add_Log.info("Select UW Reason");
				
				RenewalTesting.UWRefferralDecisionTextBox().click();
				
				RenewalTesting.UWRefferralDecisionTextBox().sendKeys(UWReasonText);
				Add_Log.info("Enter the Reason");
				
				RenewalTesting.RejectButtonUWRefferralDecision().click();
				Add_Log.info("Click reject Button");
				
				RenewalTesting.OKConfiramtionButtonUWRefferralDecision().click();
