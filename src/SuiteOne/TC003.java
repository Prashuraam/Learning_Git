...
public class TC003 extends SuiteOneBase{
	...
	public void SuiteOneCaseTwoTest(String Username,String Password,String LaunchPassword, String State,String Profession,
			...
			String AlternatePhoneNumberDropDown,String AlternatePhoneNumber,String PaymentMode1,String UserType,String CardNumber,String CVV,
			String ExpMonth,String CHFirstName,String CHLastName,String pStreetAddress,String pCity,String pState,String pZipCode,
		...
		try
		{
			test=extent.startTest("Purchase Policy by New User.");
			//Login Method	
			...
			MyProfessionalDetails.ProfessionalDetail_NewUser(State, Profession, Speciality1, county,
					writeYourSpecialty, Employment1, hasEmployerCoverage, Coverage, RetroActiveDate,
					AnticipatedGraduationMonth, AnticipatedGraduationYear, Graduatedinlast5years, GraduatedinLast_Month,
					GraduatedinLast_Year, WorkPerWeek, disciplinaryboardaction5Years, NoOfClaims, BoardAction, EffectiveDate1,
					Username, IntendedOwner);
               ...
               //**************Account Page***************
	 			...
	 			PolicyDetails.ProfessionalDetail_NewUser(Employment1, FirstName, LastName, ProfessionalDesignation, BusinessEntity,
	 					StreetAddress, City, State2, zipCode, PrimaryPhoneNumberDropDown, PrimaryPhoneNo, 
	 			...
	 			//*******Payment Details*************/
	 			PaymentDetails.PaymentDetail(CardNumber, CVV, ExpMonth, CHFirstName, CHLastName,
